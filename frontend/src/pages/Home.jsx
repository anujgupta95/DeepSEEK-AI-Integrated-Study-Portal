...
import backgroundImage2 from "/banner2.png";
  ...
  return (
    <div
      ...
      style={{
        ...
        backgroundPosition: "calc(100% + 50px) center" /* Moves image to the right */,
        backgroundRepeat: "repeat",
      }}
    >
      {/* Background Overlay (Optional for better readability) */}
      <div className="absolute inset-0 bg-yellow opacity-40"></div>
